...
class Student
{
    ...
    public double Total { get {return (Test1 + Test2) / 2; }  } 
}
class Program
{
    static void Main()
    {
       ...
       // students sorted by name
        ...
        {
            Console.WriteLine($"ID: {student.Id}, Name: {student.Name}, Test1: {student.Test1}, Test2: {student.Test2}, Total: {student.Total}, Grade: {student.Grade}");
        }
